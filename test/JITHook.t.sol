...
import {SetupHelper} from "./helpers/SetupHelper.sol";
...
contract JITHookTest is Test, Deployers, DeployPermit2 {
    ...
    function setUp() public {
        ...
        deployPosm();
        hook = helper.deployHook(manager, controller, THRESHOLD, posm);
        helper.approveTokens(hook, token0, token1);
        initializePool();
    }

    function deployPosm() internal {
        posm = helper.deployPosm(manager, _WETH9);
    }
